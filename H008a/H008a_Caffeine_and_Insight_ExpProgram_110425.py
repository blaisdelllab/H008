...
for question in questions:
    ...
    if datetime.now() >= (session_duration):
        ...
        3 (contains some key words but far from the solution), 4 (contains most of the keywords 
        in our solution but may miss some), and 5 (perfect solution).
